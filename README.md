...
**50+ скиллов**, которые превращают одну команду `/имя` в проверенный фреймворк — стратегия, дискавери, рост, маркетинг, UX. Плюс воркшоп «Как я работаю с Клодом».

🔗 **Живой сайт:** https://claude-workshop-iota.vercel.app — с витриной и полным арсеналом.

Ниже — 6 ключевых. Полный список папок → [`skills/`](./skills).
